...
package valkyrienwarfare.addon.cannon.items;

import net.minecraft.client.util.ITooltipFlag;
import net.minecraft.world.World;
import valkyrienwarfare.addon.cannon.CannonModReference;
...
public class ItemGrapeshot extends Item {
	...
	@Override
	public void addInformation(ItemStack stack, @Nullable World worldIn, List<String> itemInformation, ITooltipFlag flagIn) {
